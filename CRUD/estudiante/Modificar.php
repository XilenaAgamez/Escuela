        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                        <!-- Topbar Search -->
                    <form action="Modificar.php" method="post" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    ...
                    <?php
                      ...
                      if (isset($_POST['buscador'])){
                        ...
                        if (empty($buscar)){
                            ...
                            $sql = "SELECT * FROM estudiante WHERE id like '%$buscar%' ORDER BY id DESC";
                                ...
                                if ($row = mysqli_fetch_array($result)){
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td class=”estilo-tabla” align="center"><input type="submit" action="index.php" name="name" value="Editar"/></td>
                                        </tr> 
                                    </table>
                                    <?php
