<?php
  ...
  if(isset($_POST['insertar'])){
      ...
      $query = "INSERT INTO estudiante(id, nombre, apellido, genero) VALUES ('$id','$nombre', '$apellido', '$genero')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3>Agregar Estudiante</h3><br>
                    <form action="Agregar.php" method="post">
                        <div class="form-group">
                            <span for="validation01">Id</span>
                            <input type="number" name="id" class="form-control" placeholder="Identificacion" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="container-fluid">
                            <button type="submit" name="insertar" class="btn btn-success">Confirmar</button> 
                        </div>
                    </form>
