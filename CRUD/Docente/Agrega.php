<?php
  ...
  if(isset($_POST['insert'])){
      ...
      $query = "INSERT INTO docente(id, nombre, apellido, genero) VALUES ('$id','$nombre', '$apellido', '$genero')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3>Agregar Docente</h3><br>
                    <form action="Agrega.php" method="post">
                        <div class="form-group">
                            <span for="validation01">ID</span>
                            <input type="number" name="id" class="form-control" placeholder="Codigo" required>
                        </div>
                        <div class="form-group">
                            <span for="validation01">Nombre</span>
                            <input type="text" name="nombre" class="form-control" placeholder="Nombre" required>
                        </div>
                        <div class="form-group">
                            <span for="validation02">Apellido</span>
                            <input type="text" name="apellido" class="form-control" placeholder="Observacion">
                        </div>
                        <div class="form-group">
                            <span for="validation02">genero</span>
                        ...
                        <div class="container-fluid">
                            <button type="submit" name="insert" class="btn btn-success">Confirmar</button> 
                        </div>
                    </form>
