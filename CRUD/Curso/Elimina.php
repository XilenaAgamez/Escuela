        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Topbar Search -->
                    <form action="Elimina.php" method="post" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    ...
                    <?php            
                      if (isset($_POST['buscador'])){
                        ...
                        if (empty($buscar)){
                            ...
                            $sql = "SELECT * FROM curso WHERE Codigo like '%$buscar%' ORDER BY Codigo DESC";
                            ...
                            if ($result === false){
                                ...
                                if ($row = mysqli_fetch_array($result)){
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            <td class="estilo-tabla" align="center"><?=$row['Codigo']?></td>
                                            <td class=”estilo-tabla” align="center"><?=$row['nombre']?></td>
                                            <td class="estilo-tabla" align="center"><?=$row['Observacion']?></td>                                      
                                            <td class="estilo-tabla" align="center">
                                                <a class="btn btn-primary" href="confi.php?Codigo=<?php echo $row->Codigo;?>"></a>
                                            </td>
                                        </tr> 
                                    </table>
                                    <?php
